...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 26 Juin 2014 à 18:57
...
(35, ' rgabel ', 'log n''existe pas', 'Le compte cherchant à crée un projet n''existe pas'),
(36, ' rgabel ', 'log n''existe pas', 'Le compte cherchant à crée un projet n''existe pas'),
(37, 'rgabel', 'Le ticket n''existe pas', 'Le ticket n''existe pas'),
(38, 'rgabel', 'Le ticket n''existe pas', 'Le ticket n''existe pas'),
(39, 'rgabel', 'user n''existe pas', 'L''utilisateur assigné n''existe pas'),
(40, 'rgabel', 'user n''existe pas', 'L''utilisateur assigné n''existe pas'),
(41, 'rgabel', 'user n''existe pas', 'L''utilisateur assigné n''existe pas'),
(42, 'rgabel', 'user n''existe pas', 'L''utilisateur assigné n''existe pas'),
(43, 'rgabel', 'user n''existe pas', 'L''utilisateur assigné n''existe pas'),
(44, 'rgabel', 'user n''existe pas', 'L''utilisateur assigné n''existe pas'),
(45, 'rgabel', 'user n''existe pas', 'L''utilisateur assigné n''existe pas'),
(46, 'debug', 'CONCAT', '1'),
(47, 'debug', 'CONCAT', '12'),
(48, 'debug', 'CURRENT_TIMESTAMP', ''),
(49, 'debug', 'CONCAT', '1'),
(50, 'debug', 'CONCAT', '2'),
(51, 'debug', 'CONCAT', '2'),
(52, 'debug', 'CONCAT', '1'),
...
(44, 1, 'azerty', 'descr', 1, '2014-06-26 16:54:53', NULL, '2014-06-26 18:55:01', NULL, 1, 2);
