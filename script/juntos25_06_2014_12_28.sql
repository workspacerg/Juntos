...
--
-- Client: localhost
-- Généré le: Mer 25 Juin 2014 à 11:57
...
CREATE DEFINER=`root`@`localhost` FUNCTION `del_project`( log TEXT , idPro TEXT) RETURNS tinyint(1)
BEGIN
...
(1, 1, 'Mon premier ticket', 'Ticket de test pour le projet 1', 1, '2014-06-25 08:09:41', NULL, NULL, 3, 1, 1);
